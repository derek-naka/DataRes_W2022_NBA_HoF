...
# all of the other NBA hall of famers since 2017
...
```{r setup, include=FALSE, echo=FALSE}
# graph between career points and assists
ggplot(NBA_Final_DataSet, aes(Total_Points, Total_Assists, color = Hall_of_Fame)) +
  ...
  labs(
    x = "Career Points",
    y = "Career Assists",
    title = "Career Points & Assists of Retired NBA Players",
    color = "Hall of Fame"
  )
...
ggplot(top_25_players_ppg, aes(x=Points_Per_Game, fill=Hall_of_Fame)) +
  ...
  labs(
    x = "Points Per Game",
    y = "Number of Player",
    title = "Points Per Game of Top 25% of NBA Players",
    fill = "Hall of Fame"
  )
